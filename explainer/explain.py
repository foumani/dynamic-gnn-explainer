...
class Explainer:
    def __init__(
        ...
        self.neighborhoods = None if self.graph_mode else graph_utils.neighborhoods(adj=self.adj, n_hops=self.n_hops,
                                                                                    use_cuda=use_cuda)
        self.args = args
        self.writer = writer
...
class ExplainModule(nn.Module):
    def __init__(
        ...
        self.args = args
        self.writer = writer
        self.mask_act = args.mask_act  # Activation function of mask (ReLU, sigmoid, ...)
    ...
    def adj_feat_grad(self, node_idx, pred_label_node):
        '''
        based on self.graph_mode this method decides to be on graph or node mode
        It returns a list with size
        :param node_idx:
